...
export const PRIVACY_POLICY: LegalSection[] = [
  ...
  },
  {
    ...
    content: [
      "You have the right to access your data, correct errors, or request full account deletion. For inquiries regarding the Data Privacy Act, contact support@orasa.app.",
    ],
  },
];
